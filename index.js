class RegistrationForm {
    ...
    displayResume() {
      ...
      this.resume.innerHTML = `Rata - rata usia terdaftar adalah ${Math.round(averageUmur * 100) / 100} tahun dan rata - rata uang saku terdaftar sebesar Rp ${Math.round(averageJajan * 100) / 100}`;
    }
    ...
    showValid() {
      ...
      setTimeout(() => {
        Valid.remove();
        this.regNama.classList.remove('is-invalid');
        this.regUmur.classList.remove('is-invalid');
        this.regJajan.classList.remove('is-invalid');
      }, 3000);
    }
  }
